$(function () {
    ...
    function echart_1() {
        ...
        option = {
            ...
            legend: {
                x: 'center',
                y: '15%',
                data: ['成都', '宜宾', '绵阳', '德阳', '自贡', '泸州', '攀枝花', '西昌', '乐山', '巴中', '内江', '眉山', '雅安', '遂宁'],
                icon: 'circle',
                textStyle: {
                    color: '#fff',
                }
    ...
    function echart_0() {
        ...
        function showProvince() {
                var geoCoordMap = {
                    '成都双流国际机场': [103.96833721026445,30.558346175909717],
                    '绵阳南郊机场': [104.75655198080657,31.43195830577544],
                    '攀枝花保安营机场': [101.80422449250774,26.541218283801688],
                    '宜宾莱坝机场': [104.63301906152529,28.76967479626591],
                    '九寨黄龙机场': [103.93404376880211,33.3174464976168],
					'泸州蓝田机场': [105.3978923000706,28.853709642178946],
					'达州河市机场': [107.44003267556433,31.13199537941815],
					'康定乐山机场': [101.7531276417436,29.963390007018238],
					'南充高坪机场': [106.17411752553655,30.799674751357867],
					'广元盘龙机场': [105.71119909559062,32.39541935633915],
					'德阳广汉机场': [104.34010741606342,30.951371986252786],
					'西昌青山机场': [102.19273269898302,27.990186401204484],
                };
                var data = [{
                        name: '成都双流国际机场',
                        value: 100
    ...
    function echart_2() {
          ...
          var geoCoordMap = {
              '成都': [104.06792346330406,30.679942845419565],
			  '宜宾': [104.63301906152529,28.76967479626591],
              '绵阳': [104.70551897529308,31.50470125806144],
              '德阳': [104.40239781824484,31.131139652701419],
              '攀枝花': [101.72242315249032,26.587571257108654],
              '遂宁': [105.56488779226322,30.55749135037996],
              '南充': [106.10555398379239,30.800965168237235],
              '广元': [105.81968693999652,32.441040158428247],
              '乐山': [103.76082423877176,29.600957611095074],
              '泸州': [105.44397028920636,28.895929803860104],
              '达州': [107.49497344658866,31.214198858944735],
              '广安': [106.63572033136818,30.4639838878878],
              '巴中': [106.75791584175443,31.869189159159985],
              '雅安': [103.00935646634746,29.999716337065789],
			  '内江': [105.07305599171474,29.599461534774649],
			  '自贡': [104.77607133936438,29.359156889475668],
			  '资阳': [104.63593030167381,30.13219143395195],
			  '眉山': [103.84142956286796,30.06111507994454],
			  '康定': [101.7531276417436,29.963390007018238],
			  '马尔康': [101.98362781130204,32.00787120264676],
			  '西昌': [102.11788786037536,27.863377395840187],
          };
